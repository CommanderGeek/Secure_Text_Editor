 ...
 * used for handling integrity protection details, such as MessageDigests, message authentication codes (MAC)
...
public class IntegrityData {
    private String mac; //stored MAC
    private String signature;//stored signature
